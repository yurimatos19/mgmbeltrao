...
import heroImg from "@/assets/hero-mgm.jpg";
...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
    ...
    <div className="absolute top-1/3 right-0 w-96 h-96 rounded-full bg-secondary/10 blur-3xl hidden lg:block" />
    ...
    <div className="container relative z-10">
      <div className="max-w-3xl">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-[3.5rem] font-heading font-bold leading-[1.15] tracking-tight mb-8"
        >
